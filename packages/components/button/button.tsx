  ...
  return (
    <button
      className={classnames(styles['button'], {
        ...
        [styles['primary-outline']]: context === ButtonContext.PRIMARY && useVariant === ButtonVariant.OUTLINE,
        [styles['safe-outline']]: context === ButtonContext.SAFE && useVariant === ButtonVariant.OUTLINE,
        [styles['warning-outline']]: context === ButtonContext.WARNING && useVariant === ButtonVariant.OUTLINE,
        [styles['danger-outline']]: context === ButtonContext.DANGER && useVariant === ButtonVariant.OUTLINE,
        [styles['primary-outline']]: context === ButtonContext.PRIMARY && useVariant === ButtonVariant.GHOST,
        [styles['safe-ghost']]: context === ButtonContext.SAFE && useVariant === ButtonVariant.GHOST,
        [styles['warning-ghost']]: context === ButtonContext.WARNING && useVariant === ButtonVariant.GHOST,
        [styles['danger-ghost']]: context === ButtonContext.DANGER && useVariant === ButtonVariant.GHOST,
        [styles['danger-ghost']]: context === ButtonContext.DANGER && useVariant === ButtonVariant.GHOST,

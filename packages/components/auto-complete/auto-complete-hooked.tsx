...
import { autoCompleteUtils, AutoCompleteItem } from '$/components/auto-complete/utils';
...
interface AutoCompleteHookedProps<T extends FieldValues, TItem, TItemValue> extends Omit<ControllerProps<T>, 'render'> {
  ...
  placeholder?: string;
  id?: string;
  getItemsAsync?: (inputValue: string) => Promise<Array<TItem>>;
        ...
        render={({ field }) => {
          return (
            <AutoComplete
              ...
              getItemsAsyncDelay={getItemsAsyncDelay}
            />
          );
        }}
      />

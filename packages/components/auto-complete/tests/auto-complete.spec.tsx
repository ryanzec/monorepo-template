...
describe('auto complete component', () => {
  describe('defaultItemToString', () => {
    it('works', () => {
      // valid values
      expect(component.defaultItemToString(1)).to.equal('1');
      expect(component.defaultItemToString(true)).to.equal('true');
      expect(component.defaultItemToString('test')).to.equal('test');

      // falsely value the should convert
      expect(component.defaultItemToString(0)).to.equal('0');
      expect(component.defaultItemToString(false)).to.equal('false');
      expect(component.defaultItemToString('')).to.equal('');

      // falsely values the should not convert
      expect(component.defaultItemToString(null)).to.equal('');
      expect(component.defaultItemToString(undefined)).to.equal('');
    });
  });

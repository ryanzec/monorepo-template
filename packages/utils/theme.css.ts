...
const themeVariables = createThemeContract<StyleThemeVan>(themeVariablesContract);
...
const lightTheme = createTheme(themeVariables, {
  color: {
    white: '#ffffff',
    black: '#000000',
...
const darkTheme = createTheme(themeVariables, {
  color: {
    white: '#ffffff',
    black: '#000000',
    transparent: 'transparent',
    ...
    defaultColor: '#f1f1f1',
    safe: darkOrangeColorPalette,
    notice: darkOrangeColorPalette,
    warning: darkOrangeColorPalette,
    danger: darkOrangeColorPalette,
    text: {
      light: '#ffffff',
      dark: '#000000',
...
export { themeVariables, lightTheme, darkTheme };
